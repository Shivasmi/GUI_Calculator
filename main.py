...
window = tk.Tk()
window.title('Shiva Calcutor')
frame = tk.Frame(master=window, bg="Gray", padx=20, pady=10)
frame.pack()
entry = tk.Entry(master=frame, relief=SUNKEN, borderwidth=3, width=55)
...
button_clear.grid(row=5, column=1, columnspan=2, pady=2)
 
button_equal = tk.Button(master=frame, text="=", padx=15,
                         pady=5, width=5, command=equal)
button_equal.grid(row=5, column=0, columnspan=2, pady=2)
